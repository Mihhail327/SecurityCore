...
SecurityCore — библиотека для защиты и анализа данных.  
Модули организованы как отдельные компоненты, а документация описывает их использование и расширение.
```
